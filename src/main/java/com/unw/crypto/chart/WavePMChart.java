 ...
 * @author UNGERW
 */
public class WavePMChart extends AbstractChartPanel {

    public WavePMChart(TimeSeries series, TabPane parent) {
        super(series, parent);
    }

    public WavePMChart(TimeSeries series, TabPane parent, String currency, String exchange) {
        super(series, parent);

 ...
 */
@Component
public class FinalTradingStrategyShortV2 extends AbstractStrategy implements IFinalTradingStrategy {
...
//                .and(new StopGainRule(closePrice, Decimal.valueOf(-1))); // works
        ...
        Rule exitRule1 = new UnderIndicatorRule(rsiIndicator, DoubleNum.valueOf(params.getRsiThresholdLow()));
